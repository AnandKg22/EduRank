...
/**
 * Combat Handshake Telemetry Overlay
 * Visualizes connection states adhering to UI glassmorphism boundaries.
 */
          ...
          <div className="text-center space-y-8">
                ...
                <div>
                  ...
                  {searchTime > 15 && (
                    <p className="text-xs text-warning mt-3 animate-pulse">
                      Bot opponent deployment initialized...
                    </p>
                  )}
                </div>
            ...
            {opponent && (
              <motion.div
                ...
                className="space-y-4"
              >
                <h2 className="text-3xl font-bold font-display text-success text-glow">
                  OPPONENT FOUND!
                </h2>
